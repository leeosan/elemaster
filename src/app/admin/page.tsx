...
export default function AdminPage() {
  ...
  const handleTabChange = (t: "questions" | "users") => {
    setTab(t)
          ...
          <div className="flex gap-2 mb-3">
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-sm font-semibold transition-all
                ${tab === "questions" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
            >
              📝 문제 설정
            </button>
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-sm font-semibold transition-all
                ${tab === "users" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
            >
              👥 회원 관리
            </button>
          </div>
                      ...
                      <tr key={u.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-center">
                          <span className={`text-xs px-2 py-0.5 rounded-full font-medium
                            ${u.provider === "kakao" ? "bg-yellow-100 text-yellow-700" : "bg-gray-100 text-gray-600"}`}>
